...
class BackendConfig(models.Model):
	...
	def _default_app_drawer_bg_image(self):
		image_path = get_resource_path(
			'brain_pack_backend_ent', 'static/description', 'app-drawer-bg-image.png')
	...
	],default="pallet_1", string="Color Pallets")
	...
	],default="drawer_pallet_1", string="Drawer Color Pallets")

	appdrawer_custom_bg_color = fields.Char(string="App Drawer Custom Background Color",default="#137EE8")
	appdrawer_custom_text_color = fields.Char(string="App Drawer Custom Text Color",default="#ffffff")

	light_primary_bg_color = fields.Char(string="Primary Background Color for light",default="#137EE8")
	...
	dark_primary_bg_color = fields.Char(string="Primary Background Color for dark",default="#137EE8")
