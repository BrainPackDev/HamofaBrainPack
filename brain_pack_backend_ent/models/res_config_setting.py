...
class ResConfig(models.TransientModel):
    ...
    brain_pack_favicon = fields.Binary(related='company_id.favicon',
                            string="Backend Tab Favicon", readonly=False)
    appdrawer_icon = fields.Binary(related='company_id.appdrawer_icon',
                            string="App Drawer Favicon", readonly=False)
    ...
    # Fields for PWA end
    brain_pack_toolbar_color = fields.Char('Toolbar Color', related='company_id.brain_pack_toolbar_color', readonly=False)
