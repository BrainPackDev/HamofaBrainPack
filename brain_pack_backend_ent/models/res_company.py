...
class Company(models.Model):
    ...
    tab_name = fields.Char(string="Backend Tab Name", default="BrainPack", readonly=False)
    ...
    appdrawer_icon = fields.Binary('App Drawer Icon', readonly=False, store=True)
    ...
    app_name_pwa = fields.Char('App Name', readonly=False, default='BrainPack.io')
    short_name_pwa = fields.Char('Short Name', readonly=False, default='BrainPack.io')
    description_pwa = fields.Char('App Description', readonly=False, default='BrainPack.io')
    ...
    background_color_pwa = fields.Char('Background Color', readonly=False, default='#137EE8')
    theme_color_pwa = fields.Char('Theme Color', readonly=False, default='#137EE8')
    pwa_shortcuts_ids = fields.Many2many('pwa.shortcuts', string='PWA Shortcuts')
    brain_pack_toolbar_color = fields.Char('Toolbar Color', readonly=False, default='#137EE8')
