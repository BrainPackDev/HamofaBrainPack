...
class PwaMain(http.Controller):
    ...
    def service_worker(self):
        ...
        content = qweb._render('brain_pack_backend_ent.service_worker', {
    ...
    def pwa_offline(self, **kw):
        return request.render('brain_pack_backend_ent.pwa_offline_page',)

    @http.route('/brain_pack_backend_ent/<int:company_id>/manifest.json', type='http', auth="public")
