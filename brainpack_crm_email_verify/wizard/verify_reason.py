...
class VerifyEmailReason(models.TransientModel):
    _name = 'verify.email.reason'
    _description = 'Verify Email Reason'
    ...
    ], string='Phone Status', tracking=True)
