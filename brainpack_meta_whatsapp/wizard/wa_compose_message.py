...
class WAComposer(models.TransientModel):
    ...
    def send_whatsapp_message(self):
        ...
        if provider_channel_id:
            ...
            if user_partner.id not in channel.channel_partner_ids.ids and self.env.user.has_group('base.group_user') and self.env.user.has_group('brainpack_meta_whatsapp.whatsapp_group_user'):
